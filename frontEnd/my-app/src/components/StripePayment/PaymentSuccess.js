...
//http://localhost:3000/success?payment_intent=pi_3OercaIWXx3y9REs1PTqr97d&payment_intent_client_secret=pi_3OercaIWXx3y9REs1PTqr97d_secret_rAHDtQHEExY0RfnbGGSHayXjv&redirect_status=succeeded
const PaymentSuccess = () => {
  ...
  const { isLoading, isError, data, isPending, isSuccess } = useQuery({
    queryFn: () => verifyPaymentAPI(paymentIntentID), // function is not executed immediately when the component renders.
  });
  console.log(data);
  return (
